...
/**
 * Tom Fitch: broadcast 'datetimepicker-setTime-done' when datetime is set in setTime
 * 2017-Jul-26
 * https://hirepool.io
 */
...
;(function (root, factory) {
  ...
  function DatetimepickerDirective (defaultConfig, configurationValidator) {
    ...
    DirectiveController.$inject = ['$scope', '$element', '$attrs', '$rootScope']

    function DirectiveController ($scope, $element, $attrs, $rootScope) {
      // Configuration
      ...
      function setTime (milliseconds) {
        ...
        $rootScope.$broadcast('datetimepicker-setTime-done', newDate);
